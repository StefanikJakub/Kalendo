...
namespace kalendar.Views
{
    public partial class Menu1 : Form
    {
        ...
        {
            var eventForm = new Views.Event(Session.UserId, mesiac, rok, DateTime.Now.Day);
            eventForm.Show();
            this.Hide();
        }
        ...
        {
            var formUdalosti = new Views.Event(Session.UserId, mesiac, rok, DateTime.Now.Day);
            formUdalosti.Show();
            this.Hide();
        }
